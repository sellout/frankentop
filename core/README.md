...
[![Hackage Version](https://img.shields.io/hackage/v/frankentop)](https://hackage.haskell.org/package/frankentop)
[![Packaging status](https://repology.org/badge/tiny-repos/haskell:frankentop.svg)](https://repology.org/project/haskell:frankentop/versions)
[![latest packaged versions](https://repology.org/badge/latest-versions/haskell:frankentop.svg)](https://repology.org/project/haskell:frankentop/versions)
...
This package is licensed under [The GNU AGPL 3.0 only](./LICENSE). If you need a license for usage that isn’t covered under the AGPL, please contact [Greg Pfeil](mailto:greg@technomadic.org?subject=licensing%20frankentop).
